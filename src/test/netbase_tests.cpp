...
{
    BOOST_CHECK(TestSplitHost("www.abcoin.org", "www.abcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.abcoin.org]", "www.abcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.abcoin.org:80", "www.abcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.abcoin.org]:80", "www.abcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:6161", "127.0.0.1", 6161));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:6161", "127.0.0.1", 6161));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:6161", "::ffff:127.0.0.1", 6161));
    BOOST_CHECK(TestSplitHost("[::]:6161", "::", 6161));
    BOOST_CHECK(TestSplitHost("::6161", "::6161", -1));
    BOOST_CHECK(TestSplitHost(":6161", "", 6161));
    BOOST_CHECK(TestSplitHost("[]:6161", "", 6161));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:6161", "127.0.0.1:6161"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:6161", "[::]:6161"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
